...
$string['entity_enrol_log'] = 'Registro de limpieza de matrículas';
$string['entity_oauth2_log'] = 'Registro de limpieza de OAuth2';
$string['entity_users_log'] = 'Registro de limpieza de usuarios';
$string['oauth2cleaning_case_deletedusers'] = 'Usuarios eliminados';
$string['oauth2cleaning_case_emailnotmatch'] = 'Correo electrónico no coincide con el proveedor OAuth2';
$string['oauth2cleaning_case_suspendedusers'] = 'Usuarios suspendidos';
$string['oauth2cleaning_cases'] = 'Casos de limpieza';
$string['oauth2cleaning_cases_desc'] = 'Seleccione qué casos de limpieza de OAuth2 debe procesar la tarea programada.';
$string['oauth2cleaning_enabled'] = 'Habilitar limpieza de OAuth2';
$string['oauth2cleaning_enabled_desc'] = 'Si se habilita, la tarea programada limpiará los usuarios de OAuth2 según los casos seleccionados.';
$string['oauth2cleaning_observer'] = 'Habilitar observador para limpieza de OAuth2';
$string['oauth2cleaning_observer_desc'] = 'Si se habilita, se registrará un observador para escuchar los eventos de actualización, eliminación y suspensión de usuarios, y limpiará los usuarios de OAuth2 en consecuencia.';
...
$string['report_enrol_courseid'] = 'ID del curso';
$string['report_enrol_details'] = 'Detalles';
$string['report_enrol_timecreated'] = 'Fecha';
$string['report_enrol_title'] = 'Limpieza masiva - Matrículas';
$string['report_enrol_userid'] = 'ID del usuario';
$string['report_oauth2_details'] = 'Detalles';
$string['report_oauth2_timecreated'] = 'Fecha';
$string['report_oauth2_title'] = 'Limpieza masiva - OAuth2';
$string['report_oauth2_type'] = 'Tipo';
$string['report_oauth2_userid'] = 'ID del usuario';
$string['report_users_details'] = 'Detalles';
$string['report_users_timecreated'] = 'Fecha';
$string['report_users_title'] = 'Limpieza masiva - Usuarios';
$string['report_users_userid'] = 'ID del usuario';
$string['tab_enrolcleaning'] = 'Limpieza de matrículas';
$string['tab_oauth2cleaning'] = 'Limpieza de OAuth2';
$string['tab_userscleaning'] = 'Limpieza de usuarios';
$string['task_enrolcleaning'] = 'Tarea de limpieza de matrículas';
$string['task_oauth2cleaning'] = 'Tarea de limpieza de OAuth2';
